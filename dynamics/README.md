...
frozen INTERP M1이 runtime 밖의 분리된 runner/evaluator에서 expected label 없이 재현되는가
```
...
├─ labs/                 runtime 권한이 없는 detached INTERP runner/evaluator
...
- INTERP runner는 evaluation manifest 없이 64-cell/88-step M1을 만들고 별도 evaluator만
